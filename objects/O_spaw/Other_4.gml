...
ds_map_add(spawnAllowed, "rm_game_1_1", [O_enemy_drone, O_enemy_stalker,O_enemy_sniper,O_enemy_assault]);

// Permitir que O_enemy_sniper e O_enemy_stalker spawnem na "rm_game_1_2":
ds_map_add(spawnAllowed, "rm_game_1_2", [O_enemy_drone, O_enemy_stalker,O_enemy_sniper,O_enemy_assault,ObigMeteor]);
